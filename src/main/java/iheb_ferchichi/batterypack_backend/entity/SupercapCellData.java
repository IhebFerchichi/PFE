...
@Entity
@Data
@Table(name = "supercap_cell_data", schema = "app")
public class SupercapCellData {
    ...
    private SupercapPackData pack;

    public SupercapCellData() {
    }
    ...
    public SupercapPackData getPack() {
        return pack;
    }

    public void setPack(SupercapPackData pack) {
        this.pack = pack;
    }
}